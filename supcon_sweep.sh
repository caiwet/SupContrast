...
#SBATCH -o supcon_sex_sweep%j.out                 # File to which STDOUT will be written, including job ID (%j)
#SBATCH -e supcon_sex_sweep%j.err                 # File to which STDERR will be written, including job ID (%j)
