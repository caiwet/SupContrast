...
#SBATCH -o simclr_sex_sweep%j.out                 # File to which STDOUT will be written, including job ID (%j)
#SBATCH -e simclr_sex_sweep%j.err                 # File to which STDERR will be written, including job ID (%j)
...
python main_supcon_sweep.py --batch_size 32 \
 --cosine --dataset path --mean "(0.485, 0.456, 0.406)" \
--std "(0.229, 0.224, 0.225)" \
 --data_folder /n/groups/patel/caiwei/Artery/Carotids/CIMT_sex_split/train --size 128
 --method SimCLR
