...
#SBATCH -o simclr_all_sweep%j.out                 # File to which STDOUT will be written, including job ID (%j)
#SBATCH -e simclr_all_sweep%j.err                 # File to which STDERR will be written, including job ID (%j)
...
python main_supcon_sweep.py --batch_size 32 \
 --cosine --dataset path --mean "(0.09202574,0.08408994,0.07970464)" \
